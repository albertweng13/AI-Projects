    ...
    def find_pathlogic(problem, start, paths, pacmanStart):
        ...
        while not queue.isEmpty():
            ...
            if problem.terminalTest(current[0]):
                paths.append((logic.to_cnf(current[1]), current[2]))
                break
            ...
            for successor in successorList:
                ...
                pushlogic = current[1] & logic.PropSymbolExpr("P", nextState[0], nextState[1], nexttime) & logic.PropSymbolExpr(action, current[2])
